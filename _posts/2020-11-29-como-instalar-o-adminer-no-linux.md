...
---
O Adminer é um gerenciador de banco de dados bem simples escrito em PHP. A sua simplicidade chama a atenção, porque ele utiliza apenas um script para fazer isso. Isso, na minha opinião, torna-o bem mais simples que o PHPMyAdmin.
